...
class RealtimeSession extends import_agents.llm.RealtimeSession {
  ...
  constructor(realtimeModel) {
    ...
    this.#logger.info({
      vertexai,
      project: vertexai ? project : void 0,
      location: vertexai ? location : void 0,
      apiKeyProvided: !vertexai ? !!apiKey : void 0,
      apiVersion: httpOptions == null ? void 0 : httpOptions.apiVersion
